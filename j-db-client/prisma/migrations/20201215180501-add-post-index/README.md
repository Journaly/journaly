# Migration `20201215180501-add-post-index`

This migration has been generated by Daniel Malarz at 12/15/2020, 7:05:01 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE INDEX "title_body_index" ON "Post"("title", "body")
```
...
migration 20201209170034-change-social-media-model..20201215180501-add-post-index
--- datamodel.dml
+++ datamodel.dml
@@ -1,335 +1,337 @@
-datasource db {
...
+  postComments PostComment[]
+
+  @@index(fields: [title, body], name: "title_body_index")
+}
+
+model Language {
+  id            Int                @default(autoincrement()) @id
