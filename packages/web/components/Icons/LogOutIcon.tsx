  ...
  return (
    ...
    >
      ...
      <g data-name="Group 352">
        <g data-name="Group 351" clipPath="url(#logout-icon__a)">
          <g
            data-name="Group 350"
            transform="translate(-.053 -.343)"
            clipPath="url(#logout-icon__b)"
          >
            <g data-name="Group 349" clipPath="url(#logout-icon__c)">
              <g data-name="Group 348" clipPath="url(#logout-icon__d)">
                <g data-name="Group 347" clipPath="url(#logout-icon__b)">
                  <path
                    data-name="Path 250"
