# Migration `20200610133356-initial`

This migration has been generated by Ryan "Lanny" Jenkins at 6/10/2020, 1:33:56 PM.
...
"bio" text   ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"email" text  NOT NULL ,"handle" text  NOT NULL ,"id" SERIAL,"locationId" integer  NOT NULL ,"name" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,"userRole" "UserRole" NOT NULL DEFAULT 'FREE_USER',
    PRIMARY KEY ("id"))
...
"body" text  NOT NULL ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" SERIAL,"threadId" integer  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,"userId" integer  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "public"."Thread" (
"id" SERIAL,"position" integer  NOT NULL ,"postId" integer  NOT NULL ,"range" integer  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "public"."Image" (
"id" SERIAL,"imageRole" "ImageRole" NOT NULL ,"largeSize" text  NOT NULL ,"postId" text   ,"postId_ImageToPost" integer   ,"smallSize" text  NOT NULL ,
    PRIMARY KEY ("id"))
...
ALTER TABLE "public"."User" ADD FOREIGN KEY ("locationId")REFERENCES "public"."Location"("id") ON DELETE CASCADE  ON UPDATE CASCADE
...
ALTER TABLE "public"."Image" ADD FOREIGN KEY ("postId_ImageToPost")REFERENCES "public"."Post"("id") ON DELETE SET NULL  ON UPDATE CASCADE
