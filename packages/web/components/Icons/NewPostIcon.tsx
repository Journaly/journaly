...
function NewPostIcon({ title, titleId, ...props }: React.SVGProps<SVGSVGElement> & SVGRProps) {
  return (
    ...
    >
      ...
      <g data-name="Group 345" clipPath="url(#prefix__a)">
        <g data-name="Group 344" transform="translate(-.026 -.004)" clipPath="url(#prefix__b)">
          <g data-name="Group 343" clipPath="url(#prefix__c)">
            <g data-name="Group 342" clipPath="url(#prefix__d)">
              <g data-name="Group 341" clipPath="url(#prefix__b)">
                <path
                  data-name="Path 245"
