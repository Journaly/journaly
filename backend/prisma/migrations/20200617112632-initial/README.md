# Migration `20200617112632-initial`

This migration has been generated by Ryan "Lanny" Jenkins at 6/17/2020, 11:26:32 AM.
...
"bio" text   ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"email" text  NOT NULL ,"handle" text  NOT NULL ,"id" SERIAL,"locationId" integer   ,"name" text   ,"updatedAt" timestamp(3)  NOT NULL ,"userRole" "UserRole" NOT NULL DEFAULT 'FREE_USER',
    PRIMARY KEY ("id"))
